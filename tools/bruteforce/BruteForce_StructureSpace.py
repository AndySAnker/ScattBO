...
save_dict(result, '../../results/bruteforce/result_simulated_Gr_fast_StructureSpace.json')
...
for structure_type, results in sorted_results.items():
    ...
    for i in range(min(5, len(results))):
        print(f"Details: {results[i]}")
save_dict(result, '../../results/bruteforce/result_simulated_Sq_fast_StructureSpace.json')
...
for structure_type, results in sorted_results.items():
    ...
    for i in range(min(5, len(results))):
        print(f"Details: {results[i]}")
save_dict(result, '../../results/bruteforce/result_experimental_Gr_fast_StructureSpace.json')
...
for structure_type, results in sorted_results.items():
    ...
    for i in range(min(5, len(results))):
        print(f"Details: {results[i]}")
save_dict(result, '../../results/bruteforce/result_experimental_Sq_fast_StructureSpace.json')
