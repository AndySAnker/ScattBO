...
def BruteForce(atom='Au', simulated_or_experimental='simulated', scatteringfunction="Gr"):
    ...
    lc_list = np.arange(2.5, 4.5, 0.01)
...
save_dict(result, 'result_simulated_Gr_StructureSpace.json')
...
for structure_type, results in sorted_results.items():
    ...
    for i in range(min(5, len(results))):
        print(f"Details: {results[i]}")
save_dict(result, 'result_simulated_Sq_StructureSpace.json')
...
for structure_type, results in sorted_results.items():
    ...
    for i in range(min(5, len(results))):
        print(f"Details: {results[i]}")
save_dict(result, 'result_experimental_Gr_StructureSpace.json')
...
for structure_type, results in sorted_results.items():
    ...
    for i in range(min(5, len(results))):
        print(f"Details: {results[i]}")
save_dict(result, 'result_experimental_Sq_StructureSpace.json')
